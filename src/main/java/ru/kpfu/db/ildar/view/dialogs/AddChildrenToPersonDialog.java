...
public class AddChildrenToPersonDialog extends Dialog
{
    ...
    public AddChildrenToPersonDialog(Object owner, String title, Person parent,
                                     PeopleDAO peopleDAO, List<String> countries)
    {
        super(owner, title);
